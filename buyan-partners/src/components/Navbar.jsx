...
const Navbar = () => {
  ...
  const glassStyle = {
    ...
    backdropFilter:
      isScrolled || isMobileMenuOpen ? "blur(20px)" : "blur(12px)",
    borderColor:
      isScrolled || isMobileMenuOpen
        ? darkMode
          ? "rgba(255,255,255,0.1)"
  ...
  return (
      ...
      <div className="fixed top-0 left-0 right-0 z-50 flex flex-col items-center pointer-events-none">
        <motion.nav
          ...
          animate={{
            ...
            borderWidth: "1px",
            borderStyle: "solid",
            borderBottomColor: isMobileMenuOpen
              ? "transparent"
            ...
            paddingBottom:
              isScrolled || isMobileMenuOpen ? "0.75rem" : "1.5rem",
          }}
    ...
    /* MANTIK: Tepedeyken (!isScrolled) her zaman göster (block).
       Aşağı inince (isScrolled) küçüklerde gizle, 410px üstünde göster. */
    ${isScrolled ? "hidden min-[410px]:block" : "block"}
...
`}
          ...
          <div
            className="hidden md:flex items-center space-x-2 font-medium whitespace-nowrap z-10"
              ...
              <div className="p-4 flex flex-col space-y-1">
                {navigation.map((item) => (
                  ...
                  >
                    ...
                    <ArrowRight
                      size={20}
                      className="text-gray-400 group-hover:text-secondary -translate-x-2 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all"
                    />
                  </motion.a>
                ))}
                ...
                <motion.div
                  variants={itemVariants}
                  className="pt-2 mt-2 border-t border-gray-200/20 dark:border-white/10"
                >
                  <button
                    onClick={() => setDarkMode(!darkMode)}
