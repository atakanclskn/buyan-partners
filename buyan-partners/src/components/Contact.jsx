      ...
      <div className="container mx-auto px-6">
        <Reveal>
          <div className="grid grid-cols-1 lg:grid-cols-3 rounded-3xl overflow-hidden shadow-2xl">
              ...
              <div className="mt-12 pt-12 border-t border-white/10">
                <div className="flex items-center space-x-2 text-white/60">
                  ...
                  <span className="text-sm">
                    Şu an yeni projeler için müsaitiz
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-slate-800/80 p-12 lg:p-16 lg:col-span-2 transition-colors duration-300 border border-transparent dark:border-white/10 white:border-white/40">
              <form className="space-y-6">
                ...
                <button
                  type="button"
                  className="bg-primary text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-primary/90 transition-all flex items-center gap-2 group cursor-pointer shadow-lg shadow-primary/20"
                >
                  {contact.buttonText}
